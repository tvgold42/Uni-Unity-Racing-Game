Shader "Custom/ToonShad" {
	//Custom toon shader to give objects a black outline and binary shading
    Properties {
        ...
        _OutlineThickness("Outline Thickness", Range(0,2)) = 0.3
    }
    SubShader {
